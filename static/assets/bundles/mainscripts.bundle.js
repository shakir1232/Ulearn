...
$.AdminNexa = {}, $.AdminNexa.options = {
    ...
    activate: function () {
        var i = this, r = $("body"), t = $(".overlay");
        $(window).on("click", function (e) {
            var a = $(e.target);
            "i" === e.target.nodeName.toLowerCase() && (a = $(e.target).parent()), !a.hasClass("bars") && i.isOpen() && 0 === a.parents("#leftsidebar").length && (a.hasClass("js-right-sidebar") || t.fadeOut(), r.removeClass("overlay-open"))
        ...
        }), i.setMenuHeight(), i.checkStatuForResize(!0), $(window).resize(function () {
        ...
        if (void 0 !== $.fn.slimScroll) {
            var e = $.AdminNexa.options.leftSideBar,
                ...
                i = $("");
            i.slimScroll({destroy: !0}).height("auto"), i.parent().find(".slimScrollBar, .slimScrollRail").remove(), i.slimscroll({
                height: a + "px",
                color: e.scrollColor,
                size: e.scrollWidth,
        ...
        var a = $("body"), i = $(".navbar .navbar-header .bars"), r = a.width();
    ...
    activate: function () {
        var i = this, r = $("#rightsidebar"), t = $(".overlay");
        $(window).on("click", function (e) {
            var a = $(e.target);
...
$.AdminNexa.browser = {
    ...
    $.AdminNexa.browser.activate(), $.AdminNexa.leftSideBar.activate(), $.AdminNexa.rightSideBar.activate(), $.AdminNexa.navbar.activate(), $.AdminNexa.input.activate(), $.AdminNexa.select.activate(), $.AdminNexa.search.activate(), setTimeout(function () {
